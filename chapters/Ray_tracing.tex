...
\end{equation}
Suppose that $f$ has variance $\textrm{Var}[f]=\mathbb{E}[(f-\mathbb{E}(f))]^2 = \sigma^2[f] $, the Bienaym\'e formula leads to
...
\begin{figure}[h]
\begin{center}
    \includegraphics[width=0.75\textwidth]{qmc_raytracing.jpg}
...
\begin{figure}[h]
\begin{center}
    \includegraphics[width=0.75\textwidth]{Error_cup}
