...
\begin{figure}[h]
  ...
  \end{center}
  \caption{Distribution of the rays on \point{S}{}{}. Around $1.67 \cdot 10^4$ rays are traced using the triangulation refinement with parameters:
