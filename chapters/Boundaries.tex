...
PS error is depicted with the red line and, MC error is depicted with the blue line.  
\begin{figure}[h!]
 \begin{center}
...
In order to remove the depends of PS ray tracing from the parameter $\alpha$, we construct another procedure to detect the boundaries of the regions in target PS. 
