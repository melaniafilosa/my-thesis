...
\begin{figure}[h]
 \label{fig:planeofincidence}
     \begin{center}
     \includegraphics[width=8cm]{planeofincidence}
     \end{center}
...
-\frac{|\boldsymbol{\mathcal{B}}_{\textrm{i}}|}{\mu_\textrm{i}}\cos\myangle_{\textrm{i}}+\frac{|\boldsymbol{\mathcal{B}}_{\textrm{r}}|}{\mu_\textrm{r}}\cos\myangle_{\textrm{r}} = 
-\frac{|\boldsymbol{\mathcal{B}}_{\textrm{t}}|}{\mu_\textrm{t}}\cos\myangle_{\textrm{t}},
\end{equation}
where the negative sign in front of $|\boldsymbol{\mathcal{B}}_{\textrm{i}}|$ and $\boldsymbol{\mathcal{B}}_{\textrm{t}}$ is due to the convention that a positive direction is considered with increasing $\variabile{x}$.
...
\begin{equation}
\frac{1}{\mu_{\textrm{i}}v_{\textrm{i}}}(|\boldsymbol{\mathcal{E}}_{\textrm{i}}|-|\boldsymbol{\mathcal{E}}_{\textrm{r}}|)\cos\myangle_{\textrm{i}} = \frac{1}{\mu_{\textrm{t}}v_{\textrm{t}}}|\boldsymbol{\mathcal{E}}_{\textrm{t}}|\cos\myangle_{\textrm{t}},
\end{equation}
