...
%\label{fig:cup}
  ...
  \label{fig:rad}
  \end{figure}
\\ \indent Let us now consider a finite source. %CONTINUA
The luminance $L$ \big(unit $\big[\textrm{cd} / \textrm{m}^2\big]$\big) is the luminous flux per unit solid angle $\textrm{d}\Omega$ and  per unit projected area $\cos\myangle \textrm{d}A$.  $L$  is given by:
