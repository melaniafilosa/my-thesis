...
\end{enumerate}
Energy conservation gives some boundary conditions of the electromagnetic filed at the plane of the interface (which is perpendicular to the incident plane).
For the first case these conditions are given by 
the continuity of the the parallel component of $\boldsymbol{\mathcal{E}}$ across the boundary between the two different media that is
\begin{equation}\label{Econservation}
\mathcal{E}_{\textrm{i}}+\mathcal{E}_{\textrm{r}}= \mathcal{E}_{\textrm{t}}
\end{equation} 
and by the continuity of the perpendicular component of $\boldsymbol{\mathcal{B}}$ across the boundary between the two different media that is
\begin{equation}\label{Bconservation}
\mathcal{B}_{\textrm{i}}\cos{\textrm{i}}-\mathcal{B}_{\textrm{r}} = \mathcal{B}_{\textrm{t}}
\end{equation}.
