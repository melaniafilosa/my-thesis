...
where \set{Q}{}{} is the set of the position coordinates \var{q} and \set{P}{}{} is the set of the direction coordinates $\variabile{p}=\var{n}\sin{\tau}$ with $\tau$ the angle between the ray and the normal \vect{$\boldsymbol{\nu}$} of the line and \variabile{n} is the index of refraction of the medium in which the line is located.  
