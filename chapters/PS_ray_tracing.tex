...
Therefore, the edge-ray principle constitutes a tool for designing ideal optical systems, \cite{welford1978problem, minano1992new}.
 \begin{figure}[h]
  \begin{center}
  \includegraphics[width= 4cm]{Nonimaging_Optics-RR_SMS_Thin_Edge}
  \end{center}
...
Suppose that \set{R}{$1$}{} and \set{R}{}{} are the regions of the rays at the source and the target PS, respectively. 
...
Note that no ordered transformation of the rays from $\partial$\set{R}{$1$}{}$(\Pi)$ to $\partial$\set{R}{}{}$(\Pi)$ is required. 
It is sufficient that the rays of  $\partial$\set{R}{$1$}{}$(\Pi)$ in are transformed to the rays of $\partial$\set{R}{}{}$(\Pi)$, \cite{minano1992new}. 
...
The triangulation refinement provides more rays close to the boundaries of the regions \set{R}{}{}$(\Pi)$ each of them is formed by the rays that follow the same path $(\Pi)$.
Then, the boundaries $\partial$\set{R}{$1$}{}$(\Pi)$ are approximated by using two different approaches explained in Chapter \ref{chap:boundaries_alpha}.
...
\centering
    \includegraphics[width  = 0.8\textwidth]{region}
...
\begin{minipage}[]{\textwidth}
\centering
    \includegraphics[width  = 0.8\textwidth]{region_inside}
...
\begin{algorithmic}[1]
\Procedure{Left triangle}{VL, Ray, $\varepsilon_{\variabile{q}_1}^{\textrm{min}}, \varepsilon_{\variabile{q}_1}^{\textrm{max}}, \varepsilon_{\variabile{p}_1}^{\textrm{min}}, \varepsilon_{\variabile{p}_1}^{\textrm{max}}$}
...
\EndIf
\EndFor
\State\Return{\Call{Left Triangle}{$[\textrm{VL}(1),5, 7], \mbox{Ray}, \varepsilon_{\variabile{q}_1}^{\textrm{min}}, \varepsilon_{\variabile{q}_1}^{\textrm{max}}, \varepsilon_{\variabile{p}_1}^{\textrm{min}}, \varepsilon_{\variabile{p}_1}^{\textrm{max}}$}};
\State\Return{\Call{Left Triangle}{$[5,\textrm{VL}(2), 6], \mbox{Ray}, \varepsilon_{\variabile{q}_1}^{\textrm{min}}, \varepsilon_{\variabile{q}_1}^{\textrm{max}}, \varepsilon_{\variabile{p}_1}^{\textrm{min}}, \varepsilon_{\variabile{p}_1}^{\textrm{max}}$}};
\State\Return{\Call{Left Triangle}{$[7,6,\textrm{VL}(3)], \mbox{Ray}, \varepsilon_{\variabile{q}_1}^{\textrm{min}}, \varepsilon_{\variabile{q}_1}^{\textrm{max}}, \varepsilon_{\variabile{p}_1}^{\textrm{min}}, \varepsilon_{\variabile{p}_1}^{\textrm{max}}$}};
\State\Return{\Call{Right Triangle}{$[5,6, 7], \mbox{Ray}, \varepsilon_{\variabile{q}_1}^{\textrm{min}}, \varepsilon_{\variabile{q}_1}^{\textrm{max}}, \varepsilon_{\variabile{p}_1}^{\textrm{min}}, \varepsilon_{\variabile{p}_1}^{\textrm{max}}$}};
\EndIf \\
\Return Ray;
\EndProcedure
\end{algorithmic}
