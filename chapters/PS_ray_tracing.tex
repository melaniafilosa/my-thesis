...
This allows to construct a triangulation in \set{S}{}{} such that the rays closest to the boundaries $\partial$\set{R}{}{}$(\Pi)$
...
\centering
    \includegraphics[width=0.6\textwidth]{mc_sample.jpg}
...
\begin{subfigure}[t]{\textwidth}
\centering
    \includegraphics[width = 0.6\textwidth]{qmc_sample.jpg}
...
\begin{subfigure}[t]{\textwidth}
\centering
\includegraphics[width=0.6\textwidth]{triangulation_source}
