...
% \begin{figure}[ht]
%  \center
%  \includegraphics[width= 7cm]{boundaries_triang_target_tir}
%  \caption{\textbf{Boundaries at \set{S}{}{} and \set{T}{}{} of the TIR-collimator} The black lines show the boundaries found using $\varepsilon_{\variabile{q}_1}^{\textrm{min}}=1.6\cdot 10^{-3}$ in the triangulation refinement of the source PS..}
%  \label{fig:boundaries_TIR_triangulation}
%\end{figure}
...
\end{figure}
The results shown in Figures \ref{fig:error_tir_triangulation} and \ref{fig:error_tir_triangulation_time} are reported in Tables \ref{tab:ps_error_triangulation} and  \ref{tab:qmc_error_triangulation}.
