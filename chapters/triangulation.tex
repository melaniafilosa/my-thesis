...
Increasing the number of reflections considered, the regions in PS formed by the rays that have multiple reflections are smaller and smaller, see Figure \ref{fig:phase_space_pr}.\\ \indent 
 Rays with a large number of reflection do not give a significant contribution to the target intensity. 
% Intensity 
% Error
